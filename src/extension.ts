...
export function activate(context: vscode.ExtensionContext): void {
  const commands = [
    ...
    vscode.commands.registerCommand('sortLines.alignBySpace', sortLines.alignBySpace),
    vscode.commands.registerCommand('sortLines.alignByComma', sortLines.alignByComma),
  ];
